...
const Hero = () => {
    return (
        <div className="flex flex-col md:flex-row lg:flex-row pt-10 pb-20 mx-auto max-w-5xl justify-between px-8 tracking-tight min-[784px]:flex-col items-center" id="about">
